...
import nuxt_plugin_bootstrapvue_19e7f81a from 'nuxt_plugin_bootstrapvue_19e7f81a' // Source: .\\bootstrap-vue.js (mode: 'all')
import nuxt_plugin_axios_ef71ac78 from 'nuxt_plugin_axios_ef71ac78' // Source: .\\axios.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"htmlAttrs":{"lang":"tr"},"title":"bkmKitap - E-Ticaret Sitesi Turgay","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"bkmKitap Nuxt Vue Node Express (SSR)"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_bootstrapvue_19e7f81a === 'function') {
    await nuxt_plugin_bootstrapvue_19e7f81a(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_ef71ac78 === 'function') {
    await nuxt_plugin_axios_ef71ac78(app.context, inject)
  }
