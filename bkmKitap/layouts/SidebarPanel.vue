                    ...
                    <div class="modal-content">
                        ...
                        >
                            ...
                            <div @click="closeSidebarPanel" class="product-cart-btn">
                                <nuxt-link to="/checkout" class="btn btn-primary">Ödeme Yap</nuxt-link>
                                <nuxt-link to="/cart" class="btn btn-light">Alışveriş Listem</nuxt-link>
                            </div>
                        </div>
                        <div class="modal-body" v-else>
                            <h3>Empty!</h3>
                            <div @click="closeSidebarPanel" class="product-cart-btn">
                                <nuxt-link to="/products" class="btn btn-primary">Tüm Kitaplar!</nuxt-link>
                                <nuxt-link to="/products" class="btn btn-light">En Yenilere Göz Atın!</nuxt-link>
                            </div>
                        </div>
                    </div>
                </div>
